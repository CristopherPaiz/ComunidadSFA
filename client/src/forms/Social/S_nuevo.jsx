  ...
  return (
    <div className="flex w-full flex-col ">
      ...
      <div className="grid gap-6 mb-6 md:grid-cols-2 w-11/12 m-auto sm:w-3/5 ">
        <Input type="text" label="Nombre" placeholder="Ingrese el nombre del beneficiario" />
        <Input type="Date" label="fecha" placeholder="Ingrese fecha" />
        <Input type="text" label="Nombre del encargado" placeholder="Nombre del encargado" />
        <Input type="text" label="Dirección" placeholder="Dirección" />
        <Input type="text" label="Saldo total" placeholder="Saldo total o inicial" />

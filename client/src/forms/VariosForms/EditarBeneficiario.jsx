...
const EditarBeneficiario = () => {
  ...
  const handleDelete = async () => {
    try {
      const response = await fetch(`${API_URL}/BeneficiarioSocial/delete/${datosBeneficiarioActualizado._id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      if (!response.ok) {
        throw new Error("Error al eliminar al beneficiario", {});
      }
      const data = await response.json();
      toast.success("Se eliminó al beneficiario correctamente", {});
        ...
        <Popover placement="top" color="danger" isOpen={popOver}>
          ...
          <PopoverContent>
            <div className="px-1 py-2">
              <div className="text-small font-bold">¿Está seguro de querer eliminar al beneficiario?</div>
